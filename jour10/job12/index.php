...
try {
    ...
    // requête pour le Job 12
    $donnees = $pdo->query("SELECT prenom, nom, naissance FROM etudiants WHERE YEAR(naissance) BETWEEN 1998 AND 2018")->fetchAll(PDO::FETCH_ASSOC);
...
<body class="bg-light">
    <div class="container my-5">
        <h1 class="text-center mb-4">Job 12</h1>
