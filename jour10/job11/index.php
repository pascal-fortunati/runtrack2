...
try {
    ...
    // requête pour le Job 11
    $donnees = $pdo->query("SELECT AVG(capacite) AS capacite_moyenne FROM salles")->fetchAll(PDO::FETCH_ASSOC);
...
<body class="bg-light">
    <div class="container my-5">
        <h1 class="text-center mb-4">Job 11</h1>
