...
try {
    ...
    // requête pour le Job 08
    $donnees = $pdo->query("SELECT SUM(capacite) AS capacite_totale FROM salles")->fetchAll(PDO::FETCH_ASSOC);
...
<body class="bg-light">
    <div class="container my-5">
        <h1 class="text-center mb-4">Job 08</h1>
