...
try {
    ...
    // requête pour le Job 07
    $donnees = $pdo->query("SELECT SUM(superficie) AS superficie_totale FROM etage")->fetchAll(PDO::FETCH_ASSOC);
...
<body class="bg-light">
    <div class="container my-5">
        <h1 class="text-center mb-4">Job 07</h1>
