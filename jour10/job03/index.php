...
try {
    ...
    // requête pour le Job 03
    $donnees = $pdo->query("SELECT prenom, nom, naissance FROM etudiants WHERE sexe='Femme'")->fetchAll(PDO::FETCH_ASSOC);
...
<body class="bg-light">
    <div class="container my-5">
        <h1 class="text-center mb-4">Job 03</h1>
